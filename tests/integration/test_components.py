...
@pytest.fixture
def gradio_blocks():
    """Provide a Gradio Blocks context for components."""
...
class TestSegmentUI:
    ...
    def test_segment_ui_creation(self, gradio_blocks):
    ...
    def test_get_input_components(self, gradio_blocks):
    ...
    def test_get_output_components(self, gradio_blocks):
...
class TestCreateThreeSegments:
    ...
    def test_creates_three_segments(self, gradio_blocks):
    ...
    def test_segments_have_correct_names(self, gradio_blocks):
    ...
    def test_segments_receive_same_choices(self, gradio_blocks):
        ...
        # All segments should be created successfully
...
class TestConditionSegmentUI:
    ...
    def test_condition_segment_ui_creation(self, gradio_blocks):
    ...
    def test_condition_segment_has_condition_components(self, gradio_blocks):
    ...
    def test_get_condition_components(self, gradio_blocks):
    ...
    def test_condition_segment_inherits_base_methods(self, gradio_blocks):
    ...
    def test_condition_segment_has_all_base_components(self, gradio_blocks):
...
class TestCreateNineSegments:
    ...
    def test_creates_nine_segments(self, gradio_blocks):
    ...
    def test_segments_have_correct_types(self, gradio_blocks):
    ...
    def test_condition_segments_have_condition_components(self, gradio_blocks):
